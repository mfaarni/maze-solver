...
def main_menu():
    ...
    while True:
        ...
        draw_text('Labyrintinratkaisija', font, (255, 255, 204), screen, 240, 40)
...
def info(lab):
    ...
    print("Algoritmin suoritus kesti", "{:.8f}".format(tm_time-tm_start), "sekuntia.")
    ...
    while running:
        ...
        draw_text('Wall Follower-algoritmi:', font_2, (255, 255, 204), screen, 170, 180)
        draw_text('Algoritmin suoritus kesti '+ '{:.8f}'.format(wf_time) +" sekuntia.", font_2, (255, 255, 204), screen, 170, 220)
        draw_text('Löydetyn reitin pituus on '+ str(len(visited)) +" siirtoa.", font_2, (255, 255, 204), screen, 170, 250)
 
        draw_text('Trémauxin algoritmi:', font_2, (255, 255, 204), screen, 170, 350)
        draw_text('Algoritmin suoritus kesti '+ '{:.8f}'.format(tm_time) +" sekuntia.", font_2, (255, 255, 204), screen, 170, 390)
        draw_text('Löydetyn reitin pituus on '+ str(len(tm_visited)) +" siirtoa.", font_2, (255, 255, 204), screen, 170, 420)
