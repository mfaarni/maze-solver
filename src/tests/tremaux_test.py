...
class TremauxFollower(unittest.TestCase):
    def setUp(self):
        ...
        self.tremaux = Tremaux(self.test_maze, self.start_cords[0],self.start_cords[1])
    ...
    def test_algorithm_med(self):
        ...
        self.tremaux= Tremaux(self.test_maze, self.start_cords[0],self.start_cords[1])
        val=self.tremaux.solve()
        self.assertEqual(val[0:5], [(15, 20), (14, 20), (12, 20), (10, 20), (9, 20)])
    ...
    def test_algorithm_large(self):
        ...
        self.tremaux= Tremaux(self.test_maze, self.start_cords[0],self.start_cords[1])
        val=self.tremaux.solve()
        self.assertEqual(val[0:5], [(30, 29), (30, 30), (29, 30), (28, 30), (28, 29)])
